...
# Many of these functions have errors which have been corrected, so this file will run as is.
############
...
############
# Using error-checking of input value
